...
{
    // Math functions
    cout << pow(2, 6) << endl;   // power function
    cout << sqrt(36) << endl;    // function to find square root
    cout << round(4.2) << endl;  // rouns up the number according to the rounding rule
    cout << ceil(4.4) << endl;   // rounds up the number to the next higher whole number
    cout << floor(5.9) << endl;  // rounds up the number to the previous whole number
